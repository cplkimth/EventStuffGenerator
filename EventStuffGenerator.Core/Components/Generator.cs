...
namespace EventStuffGenerator.Core.Components
{
    ...
    {
        public static string Generate(string templatePath, string eventName, string argumentText)
        {
            List<Argument> arguments = Argument.ParseAsList(argumentText);

            var templateText = File.ReadAllText(templatePath);

            return Generate(templateText, eventName, arguments);
        }
